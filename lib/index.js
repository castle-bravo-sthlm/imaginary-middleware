...
exports.default = function (opt) {
  ...
  return function (req, res, next) {
    var _parseurl = (0, _parseurl3.default)(req);
...
var _parseurl2 = require('parseurl');
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
                ...
                return regeneratorRuntime.async(function _sendCacheFile$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        file = _fs2.default.createReadStream(sourcePath).pipe(_request2.default.post(self.serverUrl + req.query.transform + (0, _parseurl3.default)(req).search));
              ...
              self = this;
              _context2.prev = 3;
              sourcePath = _path2.default.join(this.sourceRoot, (0, _parseurl3.default)(req).pathname);
              _context2.next = 7;
